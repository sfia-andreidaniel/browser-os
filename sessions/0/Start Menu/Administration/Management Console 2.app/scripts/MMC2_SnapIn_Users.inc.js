...
MMC2_Snapins.push({
    ...
    "create": function( placeIn ) {
            ...
            dlg.grid = $export("0001-grid", (new DataGrid()).setAttr("style", "top: 4px; left: 1px; position: absolute").setAnchors({
                ...
                this.colWidths = [40, 120, 49, 127];
                this.th(["ID", "User", "Enabled", "MemberOf"]);
            ...
            MMC2_Users_cmd_refresh( dlg );
            MMC2_Users_cmd_user_edit( dlg );
            MMC2_Users_cmd_user_add( dlg );
            MMC2_Users_cmd_user_del( dlg );
            
            MMC2_Users_cmd_user_enable( dlg );
            MMC2_Users_cmd_user_disable( dlg );
