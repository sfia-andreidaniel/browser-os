function JSolitaire() {
    ...
    var dlg = new Dialog({
        "caption": "Solitaire | JSPlatform",
        "width": 1070,
        "height": getMaxY() - 50,
        "y": 5,
        "minWidth": 1070,
        "appIcon": "data:image/gif;base64,"
    });
    ...
    dlg.isGameWon = function( force ) {
        if ( dlg.decks.final[0].cards.length +
             dlg.decks.final[1].cards.length +
             dlg.decks.final[2].cards.length +
             dlg.decks.final[3].cards.length == 52
